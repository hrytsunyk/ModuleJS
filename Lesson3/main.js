...
//
// let time = 18;
// let res = (time >=0 && time < 15) ? 'перща чверть' : (time >=15 && time < 30) ? 'друга чверть'
//     :(time >=30 && time < 45) ? 'третя чверть' :(time >=45 && time < 60) ? 'четверта чверть' : 'err';
// console.log(res);
...
// let month = 26;
// let decade = (month >= 1 && month <= 10) ? 'перша декада' : (month >=11 && month <= 20) ? 'друга декада'
//     :(month >= 21 && month <= 31) ? 'третя декада' : 'err';
// console.log(decade);
//
//
// //
